    ...
    <div className="">
      <div className="w-full flex justify-between items-center py-10 max-md:px-10 max-sm:px-6 px-24">
        ...
        <div className="flex jus items-center gap-2 uppercase">
          <span className="font-[700] text-xl">CourseMix</span>{" "}
        </div>
        </Link>
        <button className="py-2 px-6 font-[600] text-sm text-white bg-black rounded-md"><Link href='/pricing'>Join Coursemix</Link></button>
      </div>
