...
const PopularBlogComponent = () => {
  ...
  return (
    <div onClick={()=>router.push(`/app/blog/3`)} className='w-full h-auto relative pb-5 min-h-[580px] border-b-[2px]'>
        ...
        <div className='absolute left-0 bottom-3 flex items-center gap-3'>
            ...
            <div>
                <div className='font-[500] uppercase'>Danesh Kumar </div>
                <div className='text-sm font-light text-gray-600'>Former Senior SDE, Coursemix</div>
            </div>
        </div>
    </div>
  )
